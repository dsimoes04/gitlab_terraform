module "habitacao_cca" {
    source                                  = "../../../../modules/gitlab-groups"
    group_name                              = "habitacao_cca"
    group_description                       = "This group represents the Carta de Crédito Associativo - CCA - contract signed with the Secretária de Habitação do Estado de São Paulo."
    ...
    parent_group_name                       = "xcoreng/business-units"
}
